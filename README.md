...
The repository now includes implementation scaffolding for **Phase 1 (Authentication)**, **Phase 2 (Blog Core)**, and **Phase 3 (Reader Experience)**:
...
- Reader pages wired for `/home`, `/post/:id`, and `/category/:id` with published-post feeds.
